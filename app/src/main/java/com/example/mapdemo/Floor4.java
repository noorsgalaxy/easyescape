...
public class Floor4 extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mGroundOverlayRotated = map.addGroundOverlay(new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.floor4_map)).anchor(0, 1)
    ...
    private String jsonData(){
        ...
        return builder.toString();
            ...
            new LatLng(13.012615137937873,74.79105577635164),
            ...
            new LatLng(13.012850990972066, 74.79107857512827)};
    ...
    private void addMarkersToMap() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                if(i==2 || i==7)
                {
                    Intent intent=new Intent(Floor4.this,Floor3.class);
                    finish();
