...
public final class DemoDetailsList {
    ...
    public static final DemoDetails[] DEMOS = {
            new DemoDetails(R.string.floorg,
                    R.string.floorg_description,
                    Floorg.class),
            new DemoDetails(R.string.floor0,
                    R.string.floor0_description,
                    Floor0.class),
            new DemoDetails(R.string.floor1,
                    R.string.floor1_description,
                    Floor1.class),
            new DemoDetails(R.string.floor2,
                    R.string.floor2_description,
                    Floor2.class),
            new DemoDetails(R.string.floor3,
                    R.string.floor3_description,
                    Floor3.class),
            new DemoDetails(R.string.floor4,
                    R.string.floor4_description,
                    Floor4.class),
