...
public class Floorg extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mImages.clear();
        mImages.add(BitmapDescriptorFactory.fromResource(R.drawable.floor56_map));
        ...
        mGroundOverlayRotated = map.addGroundOverlay(new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.floorg_map)).anchor(0, 1)
    ...
    private String jsonData(){
        ...
        return builder.toString();
            ...
            new LatLng(13.012792049419117, 74.79093572002273),
            new LatLng(13.012794662748497,74.79100948077064),
            new LatLng(13.01287175595291, 74.79109799366813),
            new LatLng(13.012896582572944, 74.79121064644676),
            new LatLng(13.012643089598729,74.79101216297965),
            new LatLng(13.012602582965433, 74.79107787710052),
            new LatLng(13.012598662968314, 74.79122137528282)};
