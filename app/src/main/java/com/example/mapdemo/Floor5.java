 ...
 */
public class Floor5 extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mImages.clear();
        mImages.add(BitmapDescriptorFactory.fromResource(R.drawable.floor5_map));
        ...
        mGroundOverlayRotated = map.addGroundOverlay(new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.floor5_map)).anchor(0, 1)
    ...
    private void addMarkersToMap() {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                if(i==2 || i==7)
                {
                    Intent intent=new Intent(Floor5.this,Floor3.class);
                    finish();
